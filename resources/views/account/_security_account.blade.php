    ...
    <div class="card-body border-top p-9">
        ...
        <div class="d-flex flex-wrap align-items-center">
            ...
            <div id="kt_signin_email_edit" class="flex-row-fluid d-none">
                <!--begin::Form-->
                <form id="kt_signin_change_email" action="{{route('account.update',$data->_id)}}" method="POST"
                      class="form">
                    @csrf
                    <div class="row mb-6">
        ...
        <div class="d-flex flex-wrap align-items-center mb-10">
            ...
            <div id="kt_signin_password_edit" class="flex-row-fluid d-none">
                <!--begin::Form-->
                <form id="kt_signin_change_password" action="{{route('account.update',$data->_id)}}" method="POST"
                      class="form">
                    @csrf
                    <div class="row mb-1">
                        <div class="col-lg-4">
